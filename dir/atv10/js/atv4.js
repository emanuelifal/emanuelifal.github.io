...
const btnExemplo = document.querySelector("#exemplo");
...
btnExemplo.addEventListener("click", () => {
    ...
    const lista = [
        ...
        new Gasto("Transporte", "2022-09-03", 80.6),
        new Gasto("Mercado", "2023-02-20", 10),
        new Gasto("Mercado", "2023-03-09", 40),
        new Gasto("Viagem", "2022-06-04", 1502.80),
        new Gasto("Transporte", "2023-06-30", 143.70),
        new Gasto("Eventos", "2022-02-14", 50)
    ];
    lista.forEach((obj) => Gasto.adicionarALista(obj));
    atualizarTabela();
});
